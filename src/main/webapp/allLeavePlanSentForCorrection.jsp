...
<head>
  ...
  <title>HRMS | All Leave Plans Sent For Correction</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Leave Plans Sent For Correction</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Leave Plans Sent For Correction</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = lpd.getEmployeeLeavePlanSendBackForCorrectReport(employeeId);
										String comment = "";
										...
										%>
											<tr>
												...
												<td><%=comment %></td>
												<td>
													<form action="editLeavePlanSentForCorrect.jsp" method="post">

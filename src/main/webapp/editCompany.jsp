...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allCompanies.jsp">All Companies</a></li>
			...
			<form action="editCompany" method="post" id="editCompany">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<input type="hidden" name="companyId" value="<%=c.getCompanyId() %>" />
											<label>Name:</label> <input type="text" value="<%=c.getName() %>"
												name="name" class="form-control" />
										</div>
										<div class="form-group">
											<label>Code Name:</label>
											<input type="text" name="codeName" class="form-control" value="<%=c.getCodeName() %>"/>
										</div>
									</div>
									<!-- /.col -->
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allCompanies.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

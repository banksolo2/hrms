...
<head>
  ...
  <title>HRMS | Approved Leave Recalled Back (Without Pay)</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Approved Leave Recalled Back (Without Pay)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Leave</a></li>
              <li class="breadcrumb-item"><a href="adminLeaveSetup.jsp">Admin Leave Setup</a></li>
              <li class="breadcrumb-item active">Approved Leave Recalled Back (Without Pay)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = ld.getHrHistoryLeaveReport("no");
										String comment = null;
										DateDao dd = new DateDao();
										while(rs.next()){
											comment = (rs.getString("comment") == null) ? "" : rs.getString("comment");
											String arr[] = rs.getDate("start_date").toString().split("-");
										%>
										<tr>
										...
										<td><%=lsd.getName(rs.getInt("leave_status_id")) %></td>
										<!--<td>

...
<head>
  ...
  <title>HRMS | Edit Pay Element Deduction Type</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Pay Element Deduction Type</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allPayElementDeductionTypesReport.jsp">All Pay Element Deduction Types</a></li>
								<li class="breadcrumb-item active">Edit Pay Element Deduction Type</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editPayElementDeductionType" method="post" id="createState">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											%>
											<input type="hidden" name="payElementDeductionTypeId" value="<%=pedt.getPayElementDeductionTypeId() %>">
											<label>Name:</label> <input type="text" value="<%=pedt.getName() %>"
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allPayElementDeductionTypesReport.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

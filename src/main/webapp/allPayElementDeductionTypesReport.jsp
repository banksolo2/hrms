...
<head>
  ...
  <title>HRMS | All Pay Element Deduction Types</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Pay Element Deduction Types</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Pay Element Deduction Types</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = pedtd.getPayElementDeductionTypesReport();
										int createdById;
										int updatedById;
										String createdBy;
										String updatedBy;
										...
										%>
											<tr>
												...
												<td><%=updatedBy %></td>
												<td>
													<form action="editPayElementDeductionType.jsp" method="post">
													<input type="hidden" name="payElementDeductionTypeId" value="<%=rs.getInt("pay_element_deduction_type_id") %>" />
													<button type="submit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</button>
													</form>
												</td>
												
												<td>
													<form action="deletePayElementDeductionType" method="post">
													<input type="hidden" name="payElementDeductionTypeId" value="<%=rs.getInt("pay_element_deduction_type_id") %>" />

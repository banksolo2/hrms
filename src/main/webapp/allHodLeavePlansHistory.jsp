...
<head>
  ...
  <title>HRMS | All Leave Plans History</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Leave Plans History</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Leave Plans History</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = lpd.getEmployeesLeavePlanHistoryReport(employeeId);
										String comment = "";
										EmployeeDao ed = new EmployeeDao();
										DepartmentDao ded = new DepartmentDao();
										DateDao dd = new DateDao();
										while(rs.next()){
											String dates[] = rs.getDate("start_date").toString().split("-");

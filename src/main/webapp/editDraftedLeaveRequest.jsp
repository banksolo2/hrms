...
<head>
  ...
  <title>HRMS | Edit Drafted Leave Request (With Pay)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Drafted Leave Request (With Pay)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Edit Drafted Leave Request (With Pay)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="employeeDraftedLeaveRequestWithPay.jsp">Go Back</a> 
			                </div>
						</div>
						<!-- /.card -->
					</div>

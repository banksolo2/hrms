...
<head>
  ...
  <title>HRMS | All Payroll Roles</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Payroll Roles</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Payroll Roles</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = prnd.getAllPayrollRoleNames();
										int createdById;
										int updatedById;
										String createdBy;
										String updatedBy;
										...
										%>
											<tr>
												...
												<td>
													<form action="editPayrollRole.jsp" method="post">
												...
												<td>
													<form action="deletePayrollRole" method="post">
													<input type="hidden" name="payrollRoleNameId" value="<%=rs.getInt("payroll_role_name_id") %>" />

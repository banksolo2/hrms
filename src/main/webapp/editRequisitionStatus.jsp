...
<head>
  ...
  <title>HRMS | Edit Requisition Status</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Requisition Status</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allRequisitionStatus.jsp">All Requisition Statues</a></li>
								<li class="breadcrumb-item active">Create Requisition Status</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editRequisitionStatus" method="post" id="createBranch">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											%>
											<input type="hidden" name="requisitionStatusId" value="<%=rs.getRequisitionStatusId() %>" >
											<label>Name:</label> <input type="text" value="<%=rs.getName() %>"
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allRequisitionStatus.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

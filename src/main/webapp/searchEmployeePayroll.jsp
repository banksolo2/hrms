...
<head>
  ...
  <title>HRMS | Search Employee Payroll</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Search Employee Payroll</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Search Employee Payroll</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="searchEmployeePayroll" method="post" id="generatePayroll">
				<!-- Main content -->

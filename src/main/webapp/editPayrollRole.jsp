...
<head>
  ...
  <title>HRMS | Edit Payroll Role</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Payroll Role</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allPayrollRole.jsp">All Payroll Roles</a></li>
								<li class="breadcrumb-item active">Edit Payroll Role</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editPayrollRole" method="post" id="createState">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											%>
											<input type="hidden" name="payrollRoleNameId" value="<%=prn.getPayrollRoleNameId() %>">
											<label>Name:</label> <input type="text" value="<%=prn.getName() %>"
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allPayrollRole.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

...
<head>
  ...
  <title>HRMS | Create Gender</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Gender</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Gender</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createGender" method="post" id="createGender">
				<!-- Main content -->

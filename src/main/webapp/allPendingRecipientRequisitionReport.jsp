				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = rd.getRecipientRequisitionReport(employeeId, rsd.getRequisitionStatusId("sent_to_recipient_for_approval"));
										while(rs.next()){
										...
										%>
											<tr>
												...
												<td>
													<form action="editRecipientsPendingRequisition.jsp" method="post">

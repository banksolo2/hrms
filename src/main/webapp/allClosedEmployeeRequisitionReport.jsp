...
<head>
  ...
  <title>HRMS |  All Closed Requisitions</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Closed Requisitions</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = rd.getRequesterRequisitionReport(employeeId, rsd.getRequisitionStatusId("closed"));
										while(rs.next()){

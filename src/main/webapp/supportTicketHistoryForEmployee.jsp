		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Support Ticket History (Employees)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Support Ticket History (Employees)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = std.getHRSupportTicketReport("employees");
										String resolvedBy;
										String comment;
										while(rs.next()){
										...
										%>
											<tr>
												...
												<td><%=resolvedBy %></td>
												<td>
													<form action="viewSupportTicketEmployee.jsp" method="post">

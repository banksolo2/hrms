...
<head>
  ...
  <title>HRMS | Make Leave Request (Without Pay)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Make Leave Request (Without Pay)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Make Leave Request (Without Pay)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="makeLeaveRequestWithoutPay" method="post" id="makeLeaveRequestWithoutPay">
				<!-- Main content -->
							 	...
							 	ResultSet rs = ltd.getAllLeaveTypeOnUpdate(0);
							         ...
							         <%
							         	while(rs.next()){
							         		...
							         		usedLeaveDays = led.getEmployeeApprovedLeaveTypeDays(employeeId, rs.getInt("leave_type_id"), "no", currentYear );
									...
									<input type="hidden" name="withPay" value="no" />
									<div class="col-md-4">
									<script>

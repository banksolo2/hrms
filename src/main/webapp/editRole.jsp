					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="allRoles.jsp">All Roles</a></li>
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<label>Name:</label> <input type="text" value="<%=r.getName() %>"
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allRoles.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

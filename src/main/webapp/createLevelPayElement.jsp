...
<head>
  ...
  <title>HRMS | Create Level Pay Element</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Level Pay Element</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Level Pay Element</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createLevelPayElement" method="post" id="createLevelPayElement">
				<!-- Main content -->
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											ResultSet rs = ld.getAllLevelsOnUpdate(levelId);
											%>
											<label>Level</label>
										...
										<div class="form-group">
											...
											rs = ped.getPayElementOptionTwo(0, esd.getElementStatusId("active"));
											%>
											<select class="select2" multiple="multiple" data-placeholder="SELECT PAY ELEMENT OPTIONS" style="width: 100%;" name="payElementId">
											<%
											while(rs.next()){
											%>

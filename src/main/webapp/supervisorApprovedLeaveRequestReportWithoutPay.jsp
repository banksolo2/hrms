...
<head>
  ...
  <title>HRMS | Approved Leave Request (Without Pay)</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Approved Leave Request (Without Pay)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Leave</a></li>
              <li class="breadcrumb-item"><a href="SupervisorLeaveSetup.jsp">Supervisor Leave Setup</a></li>
              <li class="breadcrumb-item active">Approved Leave Request (Without Pay)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = ld.getSupervisorApprovedLeaveReport(employeeId, "no");
										String comment = null;
										...
										<td>
											<form action="initiateLeaveCallBackWithoutPay.jsp" method="post">
											<input type="hidden" name="leaveId" value="<%=rs.getInt("leave_id") %>" />
											<button type="submit" class="btn btn-danger">Recall Back</button>
											</form>
										</td>
										<%} %>
										</tr>

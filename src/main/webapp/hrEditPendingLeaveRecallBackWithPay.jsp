...
<head>
  ...
  <title>HRMS | Edit Leave Request (With Pay)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Leave Request (With Pay)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Edit Leave Request (With Pay)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editHrLeaveRecallBackWithPay" method="post" id="editSupervisorPendingLeaveRequest">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							 	...
							 	ResultSet rs = ltd.getAllLeaveTypeOnUpdate(annualLeaveTypeId);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											%>
											<input type="text" class="form-control" readonly="readonly" value="<%=ded.getDepartmentName(l.getDepartmentId()).toUpperCase() %>">
										</div>
										<div class="form-group">
						            ...
						            <div class="col-md-12">
						                ...
						                <div class="form-group">
						                	...
						                	rs = lsd.getHrLeaveOptionForPendingRecallBack();
						                	%>
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="hrLeaveRecallBackPendingApproval.jsp">Go Back</a> 
			                </div>
						</div>
						<!-- /.card -->
					</div>

...
<head>
  ...
  <title>HRMS |  All Approved Requisitions</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Approved Requisitions</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Approved Requisitions</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = rd.getRequesterRequisitionReport(employeeId, rsd.getRequisitionStatusId("approved"));
										while(rs.next()){
										...
										%>
											<tr>
												...
												<td><%=ed.getEmployeeName(rs.getInt("approved_by")) %></td>
												<td>

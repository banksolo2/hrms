...
<head>
  ...
  <title>HRMS | Create Holiday</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="createHoliday" method="post" id="createHoliday">
				<!-- Main content -->
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="dateAt" value="<%=dateAt %>"
										...
										%>
											...
											<textarea rows="5" cols="50" class="form-control" name="description"><%=description %></textarea>
										</div>
									</div>
									<!-- /.col -->

...
<head>
  ...
  <title>HRMS | Create Red Zone</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Red Zone</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Red Zone</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createRedZone" method="post" id="createRedZone">
				<!-- Main content -->
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											ResultSet rs = dd.getAllDepartmentonUpdate(departmentId);
											while(rs.next()){
											%>

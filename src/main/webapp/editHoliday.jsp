...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="editHoliday" method="post" id="editHoliday">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							<div class="card-body">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										%>
											<input type="hidden" name="holidayId" value="<%=h.getHolidayId() %>">
											<label>Name</label> <input type="text" value="<%=h.getName() %>"
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="dateAt" value="<%=h.getDateAt() %>"
										...
										<div class="form-group">
											...
											<textarea rows="5" cols="50" class="form-control" name="description"><%=h.getDescription() %></textarea>
										</div>
									</div>
									<!-- /.col -->
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allHolidays.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

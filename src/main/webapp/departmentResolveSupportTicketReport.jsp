...
<head>
  ...
  <title>HRMS | All Resolved Support Tickets (Department)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Resolved Support Tickets (Department)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Resolved Support Tickets (Department)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs =  std.getEmployeeSupportTicketReport(employeeId, "department", stsd.getSupportTicketStatusId("resolved"));
										...
										%>
											<tr>
												...
												<td><%=comment %> </td>
												<td>
													<form action="departmentEditSupportTicket.jsp" method="post">

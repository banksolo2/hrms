...
<head>
  ...
  <title>HRMS | Leave History (With Pay)</title>
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = ld.getSupervisorLeaveHistoryReport(employeeId, "yes");
										String comment = null;

...
<head>
  ...
  <title>HRMS |  All Pending Requisitions</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Pending Requisitions</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Pending Requisitions</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = rd.getRequesterPendingRequisitionReport(employeeId);
										while(rs.next()){
										...
										%>
											<tr>
												...
												<td><%=rsd.getName(rs.getInt("requisition_status_id")) %></td>
												<td><a download class="btn btn-warning" href="<%=rs.getString("file_url") %>">Download File</a></td>
												<!-- td>
													<form action="editEmployeeDraftRequisition.jsp" method="post">

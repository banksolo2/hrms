...
<head>
  ...
  <title>HRMS | Edit Drafted Leave Request (Without Pay)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Drafted Leave Request (Without Pay)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Edit Drafted Leave Request (Without Pay)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editDraftedLeaveRequestWithoutPay" method="post" id="makeLeaveRequestWithoutPay">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							 	...
							 	ResultSet rs = ltd.getAllLeaveTypeOnUpdate(annualLeaveTypeId);
							         ...
							         <%
							         	while(rs.next()){
							         		...
							         		usedLeaveDays = led.getEmployeeApprovedLeaveTypeDays(l.getEmployeeId(), rs.getInt("leave_type_id"), "no", currentYear );
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<%
											rs = ltd.getAllLeaveTypeOnUpdate(l.getLeaveTypeId());
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="employeeDraftedLeaveRequestWithoutPay.jsp">Go Back</a> 
			                </div>
						</div>
						<!-- /.card -->
					</div>

...
<body class="hold-transition sidebar-mini layout-fixed">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allApprovedEmployeeRequisitionReport.jsp">All Approved Requisitions</a></li>
	...
	<form action="closeEmployeeRequisition" method="post" id="editRequisitions">
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							<div class="card-body">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label>Comment</label>
											<textarea class="form-control" name="comment" rows="4" cols="50" readonly="readonly"><%=r.getComment() %></textarea>
										</div>
										<%} %>
										<!--div class="form-group">
											<label>Save As</label>
							...
							<div class="card-footer">
			                  <button type="submit" class="btn btn-primary" id="save" onsubmit="disableSaveButton()">Close Requisition</button>

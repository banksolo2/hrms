...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allLevels.jsp">All Levels</a></li>
			...
			<form action="editLevel" method="post" id="createLevel">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											%>
											<input type="hidden" name="levelId" value="<%=l.getLevelId() %>" />
											<label>Name:</label> <input type="text" value="<%=l.getName() %>"
												name="name" class="form-control" />
										</div>
										<div class="form-group">
											<label>Leave Days</label>
											<input type="number" class="form-control" name="leaveDays" value="<%=l.getLeaveDays() %>" />
										</div>
									</div>
									<!-- /.col -->
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allLevels.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

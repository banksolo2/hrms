...
<head>
  ...
  <title>HRMS | Edit Element Status</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Element Status</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allElementStatues.jsp">All Element Statues</a></li>
								<li class="breadcrumb-item active">Edit Element Status</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editElementStatus" method="post" id="createState">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											%>
											<input type="hidden" name="elementStatusId" value="<%=es.getElementStatusId() %>" >
							...
							<div class="card-footer">
			                  ...
			                  <a href="allElementStatues.jsp" class="btn btn-info">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

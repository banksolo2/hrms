...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="createLevel" method="post" id="createLevel">
				<!-- Main content -->
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<%
											String leave = request.getParameter("leaveDays");
											int leaveDays = (leave == null) ? 0 : Integer.parseInt(leave);
											%>
											<input type="number" class="form-control" name="leaveDays" value="<%=leaveDays %>" />
										</div>
									</div>
									<!-- /.col -->

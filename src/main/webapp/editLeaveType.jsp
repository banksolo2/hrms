...
<head>
  ...
  <title>HRMS | Edit Leave Type</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="allLeaveTypes.jsp">All Leave Types</a></li>
			...
			<form action="editLeaveType" method="post" id="editLeaveType">
				<!-- Main content -->
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<label>Name:</label> <input type="text" value="<%=lt.getName() %>"
												name="name" class="form-control" />
										</div>
										<div class="form-group">
											<label>Days</label>
											<input type="number" class="form-control" name="days" value="<%=lt.getDays() %>">
										</div>
									</div>
									<!-- /.col -->

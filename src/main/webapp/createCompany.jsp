...
<head>
  ...
  <title>HRMS | Create Company</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="createCompany" method="post" id="createCompany">
				<!-- Main content -->
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="text" name="codeName" class="form-control" id="codeName" value="<%=codeName %>"/>
										</div>
									</div>
									<!-- /.col -->

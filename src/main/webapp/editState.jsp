					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">All States</a></li>
				...
				<section class="content">
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							State s = sd.getStateById(stateId);
							%>
								<div class="row">
								<%
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<input type="hidden" name="stateId" value="<%=s.getStateId() %>" />
											<label>Name:</label> <input type="text" value="<%=s.getName() %>"

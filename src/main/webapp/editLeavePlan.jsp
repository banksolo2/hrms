...
<head>
  ...
  <title>HRMS | Edit Leave Plan</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Leave Plan</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="allPendingLeavePlan.jsp">All Pending Leave Plans</a></li>
								<li class="breadcrumb-item active">Edit Leave Plan</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editLeavePlan" method="post" id="createLeavePlan">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							<div class="card-body">
								...
								int leavePlanDaysLeft = leaveDays - leavePlanUsedDays;
									...
									<div class="col-md-12">
						                ...
						                <div class="form-group">
						                	<%
						                	int leavePlanStatusId = lp.getLeavePlanStatusId();
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allPendingLeavePlan.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

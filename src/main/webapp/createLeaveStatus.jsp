...
<head>
  ...
  <title>HRMS | Create Leave Status</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Leave Status</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Leave Status</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createLeaveStatus" method="post" id="createLeaveStatus">
				<!-- Main content -->

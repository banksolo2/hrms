...
<head>
  ...
  <title>HRMS | Create Pay Element Deduction Type</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Pay Element Deduction Type</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Pay Element Deduction Type</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createPayElementDeductionType" method="post" id="createState">
				<!-- Main content -->

...
<head>
  ...
  <title>HRMS | Leave Recall Back Approved (With Pay)</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Leave Recall Back Approved (With Pay)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Leave</a></li>
              <li class="breadcrumb-item"><a href="SupervisorLeaveSetup.jsp">Supervisor Leave Setup</a></li>
              <li class="breadcrumb-item active">Leave Recall Back Approved (With Pay)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = ld.getSupervisorLeaveRecallBackApprovedReport(employeeId, "yes");
										String comment = null;

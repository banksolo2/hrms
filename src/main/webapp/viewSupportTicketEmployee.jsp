...
<head>
  ...
  <title>HRMS | View Support Ticket (Employees)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">View Support Ticket (Employees)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="coreSetup.jsp">Core Setup</a></li>
								<li class="breadcrumb-item"><a href="supportTicketHistoryForEmployee.jsp">Support Ticket History (Employees)</a></li>
								<li class="breadcrumb-item active">View Support Ticket (Employees)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
						                ...
						                <div class="form-group">
											...
											%>
											<input type="text" class="form-control" readonly="readonly" value="<%=itd.getIssueTypeName(st.getIssueTypeId()).toUpperCase() %>">
										</div>
										<div class="form-group">
											<label>Employees</label>
											<select class="select2" multiple="multiple" data-placeholder="Select Employees" style="width: 100%;" >
											<%
											int employeeIds[] = std.getEmployeesId(st.getEmployees());
										...
										<div class="form-group">
											...
											SupportTicketStatus sts = stsd.getSupportTicketStatusById(st.getSupportTicketStatusId());
											%>
											<input type="text" class="form-control" readonly="readonly" value="<%=sts.getName().toUpperCase() %>" >
										</div>
										<% if(sts.getCode().equals("closed") || sts.getCode().equals("resolved")){ %>
										<div class="form-group">
											<label>Resolved By</label>
											<input type="text" class="form-control" value="<%=ed.getEmployeeName(st.getResolvedBy()) %>" readonly="readonly">
										</div>
										<%} %>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Comment</label>
											<textarea rows="5" cols="60" class="form-control" readonly="readonly" name="comment"><%=st.getComment() %></textarea>
										</div>
									</div>
							...
							<div class="card-footer">
			                  <a class="btn btn-info" href="supportTicketHistoryForEmployee.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

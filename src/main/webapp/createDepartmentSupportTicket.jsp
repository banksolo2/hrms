...
<head>
  ...
  <title>HRMS | Create Support Ticket (Department)</title>
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											%>
												<option selected="selected" value"<%=departmentId %>"><%=ded.getDepartmentName(departmentId).toUpperCase() %></option>
											<%
											}
											rs = ded.getAllDepartmentonUpdate(departmentId);
											while(rs.next()){
											%>
							...
							<div class="card-footer">
			                  <button type="submit" class="btn btn-primary" id="save" onsubmit="disableSaveButton()">Create Ticket</button>
			                </div>
						</div>
						<!-- /.card -->
					</div>

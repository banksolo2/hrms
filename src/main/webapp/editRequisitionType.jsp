...
<head>
  ...
  <title>HRMS | Edit Requisition Type</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Edit Requisition Type</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allRequisitionType.jsp">All Requisition Types</a></li>
								<li class="breadcrumb-item active">Create Requisition Type</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="editRequisitionType" method="post" id="createBranch">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											%>
											<input type="hidden" name="requisitionTypeId" value="<%=rt.getRequisitionTypeId() %>" >
											<label>Name:</label> <input type="text" value="<%=rt.getName() %>"
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allRequisitionType.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

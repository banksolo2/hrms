...
<head>
  ...
  <title>HRMS | Initiate Leave Recall Back (Without Pay)</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Initiate Leave Recall Back (Without Pay)</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Initiate Leave Recall Back (Without Pay)</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="initiateRecallBackWithoutPay" method="post" id="initiateRecallBack">
				<!-- Main content -->

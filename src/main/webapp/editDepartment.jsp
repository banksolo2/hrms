...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allDepartments.jsp">All Departments</a></li>
			...
			<form action="editDepartment" method="post" id="editDepartment">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<label>Name:</label> <input type="text" value="<%=d.getName() %>"
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allDepartments.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

...
<head>
  ...
  <title>HRMS | All Drafted Leave Plan</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Pending Leave Plans</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = lpd.getEmployeeDraftedLeavePlanReport(employeeId);
										String comment = "";
										...
										%>
											<tr>
												...
												<td>
													<form action="editLeavePlan.jsp" method="post">
												...
												<td>
													<form action="deleteLeavePlan" method="post">
													<input type="hidden" name="leavePlanId" value="<%=rs.getInt("leave_plan_id") %>" />

...
<head>
  ...
  <title>HRMS | Create Requisition Type</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Requisition Type</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
			...
			<form action="createRequisitionType" method="post" id="createBranch">
				<!-- Main content -->

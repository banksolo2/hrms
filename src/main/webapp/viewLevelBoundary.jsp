...
<head>
  ...
  <title>HRMS | View Level Uncreated Boundary</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">View Level Uncreated Boundary</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">View Level Uncreated Boundary</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
		          ...
		          <div class="col-12">
		            ...
		            <div class="invoice p-3 mb-3">
		              ...
		              <div class="row">
		                ...
		                int levelId = (level != null) ? Integer.parseInt(level) : (int)session.getAttribute("levelId");
		                LevelDao ld = new LevelDao();
		                String levelName = ld.getLevelName(levelId);
		                ResultSet rs = bd.getUncreatedBoundary(levelId);
		                %>
		                  <h4>
		                    <i class="fas fa-user"></i> &nbsp;&nbsp;<%=levelName %></h4>
		                  ...
		                  <table class="table table-striped">
		                    ...
		                    <tr>
		                      ...
		                      <td>
								...
								<button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Create Boundary</button>
								</form>
		                      </td>
							<td></td>
		                    </tr>

...
<head>
  ...
  <title>HRMS | Create Employee Payroll Role</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Employee Payroll Role</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Employee Payroll Role</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createEmployeePayrollRole" method="post" id="createEmployeePayrollRole">
				<!-- Main content -->
						          ...
						          %>
									<div class="col-md-12">
										<div class="form-group">
											...
											ResultSet rs = eprd.getEmployeeHrOption(employeeId);
										...
										<div class="form-group">
											...
											int payrollRoleNameId = (payrollRoleName == null) ? 0 : Integer.parseInt(payrollRoleName);

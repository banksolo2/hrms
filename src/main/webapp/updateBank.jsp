					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="allBanks.js">All Banks</a></li>
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							%>
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<input type="hidden" name="bankId" value="<%=b.getBankId() %>" />
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allBanks.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

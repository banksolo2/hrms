								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										while(rs.next()){
											...
											createdBy = (createdById == 0) ? "" : ed.getEmployeeName(createdById);
											updatedBy = (updatedById == 0) ? "" : ed.getEmployeeName(updatedById);
										%>
											<tr>
												...
												<td>
													...
													<input type="hidden" name="roleId" value="<%=rs.getInt("role_id") %>" />

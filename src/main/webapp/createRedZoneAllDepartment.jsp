...
<head>
  ...
  <title>HRMS | Create Red Zone All Department</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Red Zone For All Departments</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Create Red Zone For All Departments</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<form action="createRedZoneAllDepartment" method="post" id="createRedZoneAllDepartment">
				<!-- Main content -->
									...
									<div class="col-md-12">
					                     <div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="dateFrom" value="<%=dateFrom %>"
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="dateTo" value="<%=dateTo %>"
													class="form-control" data-inputmask-alias="datetime"
													data-inputmask-inputformat="yyyy-mm-dd" data-mask>
											</div>
											<!-- /.input group -->

	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="employeeResolveSupportTicketReport.jsp">All Resolved Support Tickets (Employees)</a></li>
			...
			<!-- <form action="createEmployeeSupportTicket" method="post" id="createEmployeeSupportTicket" enctype="multipart/form-data">-->
				<form action="editEmployeeSupportTicket" method="post" id="editEmployeeSupportTicket">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<select class="select2" multiple="multiple" data-placeholder="Select Employees" style="width: 100%;" name="employees" readonly="readonly">
											<%
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="employeeResolveSupportTicketReport.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

...
<body class="hold-transition sidebar-mini layout-fixed">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="allPendingRecipientRequisitionReport.jsp">All Requisitions Pending Approval</a></li>
	...
	<form action="editRecipientsRequisition" method="post" id="editSupervisorRequisition">
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
								...
								session.setAttribute("error", null);
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<%=ed.getEmployeeName(r.getRequesterId()).toUpperCase() %>" readonly="readonly">
										</div>
										<div class="form-group">
											<label>Supervisor</label>
											<input type="text" class="form-control" readonly="readonly" value="<%=ed.getEmployeeName(r.getSupervisorId()).toUpperCase() %>">
										</div>
										<div class="form-group">
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="allPendingRecipientRequisitionReport.jsp">Go Back</a>
			                </div>
						</div>
						<!-- /.card -->
					</div>

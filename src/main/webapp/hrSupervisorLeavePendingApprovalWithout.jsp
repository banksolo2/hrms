...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="editHrPendingLeaveRequestWithout" method="post" id="editSupervisorPendingLeaveRequest">
				<!-- Main content -->
					...
					<div class="container-fluid">
						...
						<div class="card card-default">
							...
							<div class="card-footer">
			                  ...
			                  <a class="btn btn-info" href="hrLeavePendingApprovalWithoutPay.jsp">Go Back</a> 
			                </div>
						</div>
						<!-- /.card -->
					</div>

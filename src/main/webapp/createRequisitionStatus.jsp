...
<head>
  ...
  <title>HRMS | Create Requisition Status</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Create Requisition Status</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
			...
			<form action="createRequisitionStatus" method="post" id="createBranch">
				<!-- Main content -->

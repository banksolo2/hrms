		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Genders</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Genders</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										%>
											<tr>
												...
												<td><%=updatedBy %></td>
												<td>
													<form action="editGender.jsp" method="post">
													<input type="hidden" name="genderId" value="<%=rs.getInt("gender_id") %>" />
													<button type="submit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</button>
													</form>
												</td>
												
												<td>
													<form action="deleteGender" method="post">
													<input type="hidden" name="genderId" value="<%=rs.getInt("gender_id") %>" />

...
<head>
  ...
  <title>HRMS | All Leave Plan Pending Approval</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Leave Plan Pending Approval</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Leave Plan Pending Approval</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = lpd.getEmployeesLeavePlanSentForApproval(employeeId);
										String comment = "";
										...
										%>
											<tr>
												...
												<td>
													<form action="editLeavePlanSentForApproval.jsp" method="post">
													<input type="hidden" name="leavePlanId" value="<%=rs.getInt("leave_plan_id") %>" />

...
<head>
  ...
  <title>HRMS |  All Requisitions Pending Approval</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Requisitions Pending Approval</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Requisitions Pending Approval</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = rd.getSupervisorRequisitionReport(employeeId, rsd.getRequisitionStatusId("sent_to_supervisor_for_authorization"));
										while(rs.next()){
										...
										%>
											<tr>
												...
												<td><%=ed.getEmployeeName(rs.getInt("requester_id")) %></td>
												<td>
													<form action="editSupervisorPendingRequisition.jsp" method="post">

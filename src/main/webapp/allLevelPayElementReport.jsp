...
<head>
  ...
  <title>HRMS | All Level Pay Elements</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">All Level Pay Elements</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Level Pay Elements</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										ResultSet rs = lped.getLevelPayElementReport();
										...
										%>
											<tr>
												...
												<td>
													<form action="editLevelPayElement.jsp" method="post">
												...
												<td>
													<form action="deleteLevelPayElement" method="post">
													<input type="hidden" name="levelPayElementId" value="<%=rs.getInt("level_pay_element_id") %>" />
